...
const ProductCard: React.FC<ProductCardProps> = ({
  ...
  const handleRemove = () => {
    if (showActions === 'comparison') {
      removeFromComparison(productId);
      openActionModal('Успішно видалено з порівняння');
    } else if (showActions === 'favorites') {
  ...
  return (
    <div className="product-card">
      {(showActions === 'comparison' || showActions === 'favorites') && (
        <button className="remove-button" onClick={handleRemove} title="Видалити">
